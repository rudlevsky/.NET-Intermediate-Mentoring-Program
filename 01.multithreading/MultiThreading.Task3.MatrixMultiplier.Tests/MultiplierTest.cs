...
namespace MultiThreading.Task3.MatrixMultiplier.Tests
{
    ...
    public class MultiplierTest
    {
        ...
        public void ParallelEfficiencyTest()
        {
            ...
            stopwatch.Stop();
            matrixTime = stopwatch.ElapsedMilliseconds;
            ...
            stopwatch.Stop();
            parallelMatrixTime = stopwatch.ElapsedMilliseconds;

            var result = parallelMatrixTime < matrixTime;
